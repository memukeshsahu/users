...
public class ForgotPasswordController {
    ...
    public ResponseEntity<String>forgotPassword(@RequestBody EmailModel emailAddress) throws ResourceNotFoundException{


        String forgotPassword=passwordService.sentNewPassword(emailAddress.getEmailAddress().trim());
